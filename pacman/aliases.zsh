if [ -f "/etc/arch-release" ]; then
    ...
    alias paca="aurman -S"                 # default yaourt action - install one or more packages including AUR
    alias pacu="sudo pacman -Syu"               # '[u]pdate'            - upgrade all packages to their newest version
    alias pacua="aurman -Syu"             # '[u]pdate'            - upgrade all packages to their newest version
    alias pacr="aurman -Rs"           # '[r]emove'            - uninstall one or more packages
    alias pacs="pacman -Ss"         # '[s]earch'            - search for a package using one or more keywords
    alias pacas="aurman -Ss"               # '[a]ur [s]earch'      - search for a package or a PKGBUILD using one or more keywords
    alias paci="aurman -Si"                # '[i]nfo'              - show information about a package
